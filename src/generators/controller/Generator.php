...
namespace anggagewor\giing\generators\controller;
 ...
 * @since  2.0
 */
class Generator extends \anggagewor\giing\Generator
{
    /**
    ...
    public function getViewFile( $action )
    {
        if ( empty($this->viewPath) ) {
            return Yii::getAlias('@app/views/' . $this->getControllerSubPath() . $this->getControllerID()
                                 . "/$action.php"
            );
        }
