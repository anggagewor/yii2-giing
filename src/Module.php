...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'anggagewor\giing\controllers';
    /**
    ...
    public function bootstrap( $app )
    {
        if ( $app instanceof \yii\web\Application ) {
            ...
            $app->controllerMap[ $this->id ] = [
                'class'      => 'anggagewor\giing\console\GenerateController',
    ...
    {
        return [
            'model'      => [ 'class' => 'anggagewor\giing\generators\model\Generator' ],
            'crud'       => [ 'class' => 'anggagewor\giing\generators\crud\Generator' ],
            'controller' => [ 'class' => 'anggagewor\giing\generators\controller\Generator' ],
            'form'       => [ 'class' => 'anggagewor\giing\generators\form\Generator' ],
            'module'     => [ 'class' => 'anggagewor\giing\generators\module\Generator' ],
            'extension'  => [ 'class' => 'anggagewor\giing\generators\extension\Generator' ],
        ];
    }
